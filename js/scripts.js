...
(function($) {
    ...
    //      Skills
    // ======================================
    var $isotopeSkillsContainer = $("#skills-container"),
        $isotopeSkillsFilters = $("#skills-filters"),
        $isotopeSkillsFilter = $isotopeSkillsFilters.find('a'),
        filterValue = 0;

    function init_skills_isotope() {
        if ($isotopeSkillsContainer.length) {
            (function($) {
                // "use strict";
                //
                // setting the layout mode
                var isotope_mode;
                if ($isotopeSkillsContainer.hasClass("masonry")) {
                    isotope_mode = "masonry";
                } else {
                    isotope_mode = "fitRows";
                }
                // initial state
                $isotopeSkillsContainer.imagesLoaded(function() {
                    $isotopeSkillsContainer.isotope({
                        // options
                ...
                // });
                // when filter are clicked
                $isotopeSkillsFilters.on("click", "a", function() {
                    var $this = $(this);
                    // setting the selected button
                    $isotopeSkillsFilter.removeClass("selected");
                    $this.addClass("selected");
                    // setting the filter
                    filterValue = $this.attr("data-filter");
                    $isotopeSkillsContainer.isotope({
